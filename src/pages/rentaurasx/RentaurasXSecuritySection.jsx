      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.div
            ...
            variants={fadeInUp}
            animate={{ color: ["#0BB0CD", "#10B981", "#0BB0CD"] }}
            transition={{ color: { duration: 3, repeat: Infinity, repeatType: "reverse" } }}
          >
            {t.safetyInnovation}   {/* 🟩 */}
          </motion.div>

          <motion.h2 className="text-3xl font-bold text-black mb-6" variants={textReveal}>
            {t.yourJourneySecure}  {/* 🟩 */}
          </motion.h2>

          <motion.p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto" variants={fadeInUp}>
            {t.firstIntroduceWomen}  {/* 🟩 */}
          </motion.p>
          ...
          <motion.button
            ...
            variants={fadeInUp}
            whileHover={{ ...buttonHover, boxShadow: "0 8px 25px rgba(0, 0, 0, 0.3)" }}
            whileTap={buttonTap}
          >
            <motion.span
            ...
            />
            <span className="relative z-10">{t.downloadRentaurasX}</span> {/* 🟩 */}
          </motion.button>
        </motion.div>
      </div>
    </motion.section>
